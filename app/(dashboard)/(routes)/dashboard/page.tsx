        ...
        <div>
            <div className="mb-8 space-y-4">
                <h2 className="text-2xl  text-center md:text-4xl font-bold">
                    Explore the power of innvation
                </h2>
            ...
            <div className="px-4 md:px-20 lg:px-32 space-y-4">
                {tools.map((tools) => (
                    ...
                    key={tools.href}
                        className="p-2 border-black/5 items-center justify-between hover:shadow-md transition cursor-pointer relative"
                    >
                        ...
                        <ArrowRight className="absolute top-0 right-0 w-5 h-5 m-5" />
                    </Card>
                ))}
            </div>
        </div>
